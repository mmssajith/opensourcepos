...
<head>
    ...
    <?php if (ENVIRONMENT == 'development' || get_cookie('debug') == 'true' || $request->getGet('debug') == 'true') : ?>
        ...
        <link rel="stylesheet" href="resources/css/ospos-56b09eab0f.css">
        <link rel="stylesheet" href="resources/css/popupbox-e6935846d3.css">
        <link rel="stylesheet" href="resources/css/receipt-0606f1c54e.css">
        <link rel="stylesheet" href="resources/css/register-c6ffc4b40e.css">
        <link rel="stylesheet" href="resources/css/reports-17763843a8.css">
        <!-- endinject -->
        <!-- inject:debug:js -->
        ...
        <script src="resources/js/html5-qrcode-d88d3200cb.min.js"></script>
        <script src="resources/js/barcode_scanner-c6418a6e57.js"></script>
        <script src="resources/js/nominatim-89be77a11a.autocomplete.js"></script>
        <!-- endinject -->
    <?php else : ?>
        <!--inject:prod:css -->
        <link rel="stylesheet" href="resources/opensourcepos-625dcbab88.min.css">
        <!-- endinject -->
        ...
        <script src="resources/opensourcepos-4f0095a015.min.js"></script>
        <!-- endinject -->
    <?php endif; ?>
